...
check('buildGroupedList: um header antes do primeiro item de um grupo contíguo', function () {
...
check('buildGroupedList: grupos diferentes e não-contíguos geram um header cada', function () {
    var itemA1 = { group: 'X' };
