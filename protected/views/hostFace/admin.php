...
<button class="btn btn-link text-decoration-none text-body p-0 mb-3 d-inline-flex align-items-center gap-2 pnm-search-toggle collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#host-face-search" aria-expanded="false" aria-controls="host-face-search">
	<span>🔍 Advanced Search</span>
	<span class="pnm-search-chevron text-body-secondary" aria-hidden="true">▾</span>
</button>
<div class="collapse mb-3" id="host-face-search">
	<p class="note">
